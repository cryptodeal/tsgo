...
/* eslint-disable */
import { dlopen, FFIType, toArrayBuffer, ptr } from 'bun:ffi';
...
export class _DemoStruct3 {
  ...
  static init  = (arr: number[] | Float32Array) => {
    if (!(arr instanceof Float32Array)) {
      arr = new Float32Array(arr);
    }
    return new _DemoStruct3(_INIT_DemoStruct3(ptr(arr), arr.length))
  }
