...
export const {
  symbols: {
    ...
    _TestStruct,
    GET_StructBar_Field,
    GET_StructBar_FieldWithWeirdJSONTag,
    GET_StructBar_FieldThatShouldBeOptional,
    GET_StructBar_FieldThatShouldNotBeOptional,
    GET_StructBar_FieldThatShouldBeReadonly
    _Float32ArrayTest,
    _Float64ArrayTest,
    _Float32ArgTest,
    _IntTest,
