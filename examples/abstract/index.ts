...
export class _StructBar {
  ...
  static init(struct: StructBar): _StructBar {
    ...
    return new _StructBar(_INIT_StructBar(ptr(_Field), FieldWithWeirdJSONTag, ptr(_FieldThatShouldBeOptional), ptr(_FieldThatShouldNotBeOptional), ptr(_FieldThatShouldBeReadonly), ptr(ArrayField), _StructField.ptr, ));
  }
...
export class _DemoStruct {
  ...
  static init(struct: DemoStruct): _DemoStruct {
    ...
    if (!(ArrayField instanceof Float32Array)) ArrayField = new Float32Array(ArrayField);
    return new _DemoStruct(_INIT_DemoStruct(ptr(ArrayField), _FieldToAnotherStruct.ptr, ));
  }
...
export class _DemoStruct2 {
  ...
  static init(struct: DemoStruct2): _DemoStruct2 {
    ...
    return new _DemoStruct2(_INIT_DemoStruct2(ptr(AnotherArray), _BacktoAnotherStruct.ptr, ));
  }
